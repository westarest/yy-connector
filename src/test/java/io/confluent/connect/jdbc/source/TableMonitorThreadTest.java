...
public class TableMonitorThreadTest {
  ...
  public void testSingleLookup() throws Exception {
    tableMonitorThread = new TableMonitorThread(cachedConnectionProvider, context, null, POLL_INTERVAL, null, null, DEFAULT_TABLE_TYPES,null);
  ...
  public void testWhitelist() throws Exception {
    tableMonitorThread = new TableMonitorThread(cachedConnectionProvider, context, null, POLL_INTERVAL,
                                                new HashSet<>(Arrays.asList("foo", "bar")), null, DEFAULT_TABLE_TYPES,null);
  ...
  public void testBlacklist() throws Exception {
    tableMonitorThread = new TableMonitorThread(cachedConnectionProvider, context, null, POLL_INTERVAL,
                                                null, new HashSet<>(Arrays.asList("bar", "baz")), DEFAULT_TABLE_TYPES,null);
  ...
  public void testTableType() throws Exception {
    tableMonitorThread = new TableMonitorThread(cachedConnectionProvider, context, null, POLL_INTERVAL, null, null, VIEW_TABLE_TYPES,null);
  ...
  public void testInvalidConnection() throws Exception {
    ...
    tableMonitorThread = new TableMonitorThread(provider, context, null, POLL_INTERVAL, null, null, VIEW_TABLE_TYPES,null);
